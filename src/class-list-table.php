  ...
  /**
	...
	public function column_default( $item, $column_name ) : string {
		switch ( $column_name ) {
			...
			case 'actions':
				return sprintf(
					'<a href="%s">%s</a> | <a href="%s&TB_iframe=true&width=600&height=500" class="thickbox">%s</a> | <a href="%s&TB_iframe=true&width=600&height=500" class="thickbox">%s</a> |  <a href="%s&TB_iframe=true&width=600&height=500" class="thickbox">%s</a>',
